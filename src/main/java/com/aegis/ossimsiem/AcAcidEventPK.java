 ...
 */
@Embeddable
public class AcAcidEventPK implements Serializable {
    ...
    public AcAcidEventPK() {
    }

    public AcAcidEventPK(byte[] ctx, int deviceId, int pluginId, int pluginSid, Date timestamp, byte[] srcHost, byte[] dstHost, byte[] srcNet, byte[] dstNet) {
        this.ctx = ctx;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AcAcidEventPK)) {
            return false;
        }
        AcAcidEventPK other = (AcAcidEventPK) object;
    ...
    public String toString() {
        return "com.aegis.ossimsiem.AcAcidEventPK[ ctx=" + ctx + ", deviceId=" + deviceId + ", pluginId=" + pluginId + ", pluginSid=" + pluginSid + ", timestamp=" + timestamp + ", srcHost=" + srcHost + ", dstHost=" + dstHost + ", srcNet=" + srcNet + ", dstNet=" + dstNet + " ]";
    }
